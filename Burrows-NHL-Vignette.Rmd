...
This tutorial explains how to access and summarize the data from the National Hockey League's APIs. 

The following packages were used to create this tutorial: `assertthat`, `knitr`, `tidyverse`, `rmarkdown`, `httr`, and `jsonlite`. 
...
The predominance of winning teams in the NHL can be visualized with a histogram. The density line peaks at a win/loss differential of 10. 
...
## Regular Season Numeric Summaries by Group 

Six number summaries are calculated for three variables for each division for the regular season. 
